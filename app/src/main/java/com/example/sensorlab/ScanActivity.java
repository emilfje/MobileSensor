...
import com.example.sensorlab.uiutils.BtDeviceAdapter;

import java.util.ArrayList;
import java.util.List;

import static com.example.sensorlab.uiutils.MsgUtils.showToast;

/**
 * A class to scan for movesense devices
